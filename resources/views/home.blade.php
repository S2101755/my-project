    ...
    <section class="hero">
        ...
        <div class="container">
            <div class="row">
                ...
                <!-- Registration Button -->
                <a href="{{ route('register') }}" class="btn btn-primary btn-lg btn-with-shadow">{{ $registerBtnText }}</a>
                
                <!-- Login Button -->
                <a href="{{ route('login') }}" class="btn btn-secondary btn-lg btn-with-shadow">{{ $loginBtnText }}</a>
                </div>
            </div>
        </div>
    </section>
